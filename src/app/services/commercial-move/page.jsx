      ...
      <div className="mx-auto max-w-6xl px-6 py-14">
        ...
        <div data-anim-section className="rounded-2xl p-10 mb-20 bg-surface border-2 border-foreground/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              ["Furniture Disassembly & Full Reassembly", "Desks, workstations, conference tables, and freestanding or modular shelving are disassembled safely before loading and fully reassembled at your new space — according to your floor plan."],
        ...
        <div data-anim-section className="rounded-2xl p-10 mb-20 bg-primary text-white">
          ...
          <p data-anim-item className="text-white/70 mt-6 font-sans text-sm">
            Don&apos;t see your business type? We work with all commercial clients — call{" "}
            {CONTACT_INFO.officePhone} (office) or {CONTACT_INFO.directPhone} /{" "}
            {CONTACT_INFO.directPhone2DisplaySpaced} (direct) for a custom quote tailored to your move.
          </p>
        </div>
